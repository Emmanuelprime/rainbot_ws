...
static const _AddTwoints_Request_type_support_symbol_names_t _AddTwoints_Request_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, rain_arm_msgs, srv, AddTwoints_Request)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, rain_arm_msgs, srv, AddTwoints_Request)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, rain_arm_msgs, srv, AddTwoints_Request)() {
  return &::rain_arm_msgs::srv::rosidl_typesupport_c::AddTwoints_Request_message_type_support_handle;
}
...
static const _AddTwoints_Response_type_support_symbol_names_t _AddTwoints_Response_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, rain_arm_msgs, srv, AddTwoints_Response)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, rain_arm_msgs, srv, AddTwoints_Response)),
  }
};
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, rain_arm_msgs, srv, AddTwoints_Response)() {
  return &::rain_arm_msgs::srv::rosidl_typesupport_c::AddTwoints_Response_message_type_support_handle;
}
...
static const _AddTwoints_type_support_symbol_names_t _AddTwoints_service_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, rain_arm_msgs, srv, AddTwoints)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_c, rain_arm_msgs, srv, AddTwoints)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_c, rain_arm_msgs, srv, AddTwoints)() {
  return &::rain_arm_msgs::srv::rosidl_typesupport_c::AddTwoints_service_type_support_handle;
}
