...
static const _QuarternionToEuler_Request_type_support_symbol_names_t _QuarternionToEuler_Request_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, rain_arm_msgs, srv, QuarternionToEuler_Request)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, rain_arm_msgs, srv, QuarternionToEuler_Request)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, rain_arm_msgs, srv, QuarternionToEuler_Request)() {
  return &::rain_arm_msgs::srv::rosidl_typesupport_c::QuarternionToEuler_Request_message_type_support_handle;
}
...
static const _QuarternionToEuler_Response_type_support_symbol_names_t _QuarternionToEuler_Response_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, rain_arm_msgs, srv, QuarternionToEuler_Response)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, rain_arm_msgs, srv, QuarternionToEuler_Response)),
  }
};
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, rain_arm_msgs, srv, QuarternionToEuler_Response)() {
  return &::rain_arm_msgs::srv::rosidl_typesupport_c::QuarternionToEuler_Response_message_type_support_handle;
}
...
static const _QuarternionToEuler_type_support_symbol_names_t _QuarternionToEuler_service_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, rain_arm_msgs, srv, QuarternionToEuler)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_c, rain_arm_msgs, srv, QuarternionToEuler)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_c, rain_arm_msgs, srv, QuarternionToEuler)() {
  return &::rain_arm_msgs::srv::rosidl_typesupport_c::QuarternionToEuler_service_type_support_handle;
}
