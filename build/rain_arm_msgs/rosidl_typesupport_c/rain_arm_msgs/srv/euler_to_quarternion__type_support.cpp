...
static const _EulerToQuarternion_Request_type_support_symbol_names_t _EulerToQuarternion_Request_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, rain_arm_msgs, srv, EulerToQuarternion_Request)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, rain_arm_msgs, srv, EulerToQuarternion_Request)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, rain_arm_msgs, srv, EulerToQuarternion_Request)() {
  return &::rain_arm_msgs::srv::rosidl_typesupport_c::EulerToQuarternion_Request_message_type_support_handle;
}
...
static const _EulerToQuarternion_Response_type_support_symbol_names_t _EulerToQuarternion_Response_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, rain_arm_msgs, srv, EulerToQuarternion_Response)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, rain_arm_msgs, srv, EulerToQuarternion_Response)),
  }
};
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, rain_arm_msgs, srv, EulerToQuarternion_Response)() {
  return &::rain_arm_msgs::srv::rosidl_typesupport_c::EulerToQuarternion_Response_message_type_support_handle;
}
...
static const _EulerToQuarternion_type_support_symbol_names_t _EulerToQuarternion_service_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, rain_arm_msgs, srv, EulerToQuarternion)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_c, rain_arm_msgs, srv, EulerToQuarternion)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_c, rain_arm_msgs, srv, EulerToQuarternion)() {
  return &::rain_arm_msgs::srv::rosidl_typesupport_c::EulerToQuarternion_service_type_support_handle;
}
